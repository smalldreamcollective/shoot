...
export type ShootActionTypes = GetShootsActionType | GetShootActionType | SetShootsActionType| AddShootActionType | UpdateShootActionType | DeleteShootActionType | GetShootsActionType | ShootsUpdatedActionType;